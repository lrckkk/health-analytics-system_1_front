      ...
      <div class="header-content">
        ...
        <div class="stats-container">
          <div class="stat-card" style="--delay: 0s">
            <p class="stat-label">机构总数</p>
            <p class="stat-value">{{ resultByIdDisplay }}</p>
          </div>
          <div class="stat-card" style="--delay: 0.1s">
            <p class="stat-label">平均增长率</p>
            <p class="stat-value">
          ...
          <div class="stat-card" style="--delay: 0.2s">
            <p class="stat-label">下一年估算值</p>
            <p class="stat-value">
              <span v-if="growthStore.getEstimatedNextYearValue('0') !== null">
